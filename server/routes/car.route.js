...
router.put('/update-car/:id', isAuthenticated, authorize(['admin']), upload.single('image'), updateCarDetails);
router.delete('/delete-car/:id', isAuthenticated, authorize(['admin']), deleteCarDetails);
